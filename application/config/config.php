...
error_reporting(0);
       ...
       defined("CHARGED_EZEE", array('503509'));
        ...
        define("WITHDRAWS",array('28310716','4432361','28317550','50017548')); //transactions/codes that cach back

		//INTERSWITCH

		define("REF_PREFIX","ZDY");
		define("EXEC_TIMEOUT", 60);
		define("PROCESS_TIMEOUT", 50);


    //LIVE
    //
         //$base_url ="https://services.interswitchug.com/api/";
        ...
        $config['base_url'] = 'http://localhost/cash/';
        define('ASSET_URL', $config['base_url'].'assets/');
        define('BASEURL', $config['base_url']);
        define('CALLBACK_FILE','callbacks.txt');
//links
