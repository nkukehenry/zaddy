            <div class="row padded col-md-12 " style="width: 100%;">
                    <div class=" card w-100" >
                        ...
                        <div class="card-body">
                            ...
                            <form class="form-material" method="post" action="<?php echo BASEURL;?>agents/saveAgent" enctype="multipart/form-data">
                                <!-- Input -->
                                <div class="body">
                                    <div class="row clearfix">
                                        <div class="col-sm-6">
                                            <div class="form-group form-float">
                                                <div class="form-line">
                                                    <input type="text" name="names" class="form-control" required autocomplete="off">
                                    ...
                                    <div class="col-sm-6">
                                           ...
                                           <div class="form-group form-float">
                                            ...
                                            <div class="form-group form-float">
                                                <div class="form-line">
                                                    <input type="text" name="agentNo" class="form-control"  autocomplete="off" value="<?=$agentNo?>" readonly>
