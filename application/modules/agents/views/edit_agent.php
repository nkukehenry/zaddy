                        ...
                        <div class="card-body">
                            ...
                            <form class="form-material" method="post" action="<?php echo BASEURL;?>agents/saveAgentEdit/<?=$agent->agentNo?>" enctype="multipart/form-data">
                                ...
                                <div class="body">
                                             ...
                                             <div class="form-group form-float">
                                                <div class="form-line">
                                                    ...
                                                    <?php 
 														$male="";
                                                        $female="";
														($agent->gender=="M")?$male="selected":$female="selected";
                                            ...
                                            <div class="form-group form-float">
                                                <div class="form-line">
                                                    ...
                                                    ?>
                                                        ...
                                                        <option value="2" <?=$res?> >Restricted</option>
                                                    </select>
                                    ...
                                    <div class="form-group form-float">
                                                <div class="form-line">
                                                    <input type="text" name="refferalAgent" class="form-control"  autocomplete="off"  value="<?=$agent->refferalAgent?>" >
                                                    <label class="form-label" required>Referral Code:</label>
                                                </div>
                                            </div>
