            ...
            <div class="row">
                 ...
                 <div class="col-md-12 " style="width: 100%; margin-bottom:10px;">
                    <div class=" card w-100" >
                        ...
                        <div class="card-body">
                            <form class="form-material" method="post" action="<?php echo BASEURL;?>reports/mytransactions" enctype="multipart/form-data">
                            ...
                            <div class="col-sm-12 col-lg-3">
                                    <div class="form-group form-float">
                                        <div class="form-line">
                                            <input type="text" name="customerNo" class="form-control"  autocomplete="off" value="
                 <?php echo  (empty($search['customerNo']))? :$search['customerNo']; ?>" >
