                                    ...
                                    <td>
                                        ...
                                        <td>
                                            ...
                                            if($transaction->tranStatus=="SUCCESSFUL")
                                              echo $transaction->agent_fee;
                                            //Modules::run('reports/getFees',$transaction->amount,$transaction->paymentCode); 
                                           ...
                                           <td>
                                            ...
                                            if($transaction->tranStatus=="SUCCESSFUL")
                                              echo ($transaction->our_fee - $transaction->agent_fee);
                                            //Modules::run('reports/getFees',$transaction->amount,$transaction->paymentCode); 
             ...
             function checkStatus(requestRef){
                                   ...
                                   $.ajax({
                                    ...
                                    if(!msg)
                                        ...
                                        msg=results.responseMessage.replace("Quickteller","Zaddy Wallet").replace("Interswitch","");
                        ...
                        function printDiv(requestRef) 
                        {
                          ...
                          var msg=$('.msg').html().toString();
                           ...
                           msg=msg.replace("Quickteller","Zaddy Wallet").replace("Interswitch","");
                        
                          $('.msg').html(msg);
                            
                          newWin.document.open();
                        
                          newWin.document.write('<html><body onload="window.print()"> <br><hr> <center><h2>ZADDY RECEIPT <br></h2><h4>'+requestRef+'</h4> </center>'+divToPrint.innerHTML+'<br><hr> <center>Contact: +256 704 878 224 <br><h2>Thank you for using Zaddy</center></h2> <br></body></html>');
