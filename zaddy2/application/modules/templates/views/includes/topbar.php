<div class="has-sidebar-left">
    ...
    <div class="sticky">
        <div class="navbar navbar-expand navbar-dark d-flex justify-content-between bd-navbar bg-main">
         ...
         <a href="#" data-toggle="collapse" data-target="#navbarToggleExternalContent" aria-expanded="false"
           aria-label="Toggle navigation" class="paper-nav-toggle paper-nav-white text-mild active ">
                        ...
                        <li>
                            <a href="#">
                                <div class="avatar float-left">
                                    <img src="<?php echo ASSET_URL; ?>img/people/u4.png" alt="">
            ...
            <ul class="dropdown-menu dropdown-menu-right">
                ...
                <li>
                    ...
                    <ul class="menu">
                        <li>
                            <a href="#">
                                <i class="icon icon-data_usage text-success"></i> 1 new agent joined today
                            </a>
                        </li>
