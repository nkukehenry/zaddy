...
?>
            <div class="row" >
                 ...
                 <div class="col-md-12 " style="width: 100%;  margin-bottom:10px;">
                    <div class=" card w-100" >
                        ...
                        <div class="card-body">
                            <form class="form-material" method="post" action="<?php echo BASEURL;?>reports/transactions" enctype="multipart/form-data">
                            ...
                            <div class="col-sm-12 col-lg-2">
                                    <div class="form-group form-float">
                                        <div class="form-line">
                                            <input type="text" name="key" class="form-control"  autocomplete="off" value="<?php echo $search['key']; ?>" >
                            ...
                            <div class="col-sm-12 col-lg-3">
                                ...
                                <a href="<?php echo BASEURL; ?>reports/exportExcelTrans/<?php echo $search['startDate']; ?>/<?php echo $search['endDate']; ?>/<?php echo $search['agentNo']; ?>/<?php echo $search['customerNo']; ?>/<?php echo $search['tranStatus']; ?>" class="btn btn-success" >
                                    EXCEL DOWNLAOD
                                </a>                            </div>
                            ...
                            <div class="table-responsive">
                                <table class="table table-hover ">
                                    ...
                                    <tr class="">
                                        <td>
                                            <?php
                                        echo date('Y-m-d h:i A', strtotime($transaction->paymentDate));
                                        ...
                                        <td class="text-dark"> 
                                        <?php 
                                           $responseObj = json_decode($transaction->responseObject);
                                           echo $responseObj->transferCode;
                                        ?>
                                        </td>
                                        <td>
                                            <?php 
                                          ...
                                          else if(strpos($transaction->requestRef,"COMS") !==false){
                                            ...
                                            else { echo $transaction->itemName; }
                                             ...
                                             <ul class="list-group" style="list-style:none;">
                                              ...
                                              <li class="list-group-item">ITEM : <?php 
                                                            if ($transaction->paymentCode=="LOAD"){ echo  "WALLET LOAD";} 
                                                                   ...
                                                                   echo $transaction->itemName; 
                                                               }?>
                                            </li>
                                              <li class="list-group-item">AMOUNT : <?php echo $transaction->amount; ?></li>
                                        <li class="list-group-item">NARRATION : <?php echo urldecode($transaction->narration); ?></li>
                                            </ul>
                                        </div>
            ...
            function markSuccess(ref) {
              ...
              var reason = prompt("This transaction will be marked as successful,Please enter reason", "It was confirmed successful");
              if (reason != null) {
                console.log(ref);
                window.location.href = "<?php echo BASEURL; ?>payment/markSuccess/"+ref+"/"+reason;;
             ...
             function markFailed(ref) {
              ...
              var reason = prompt("This transaction will be marked as failed,Please enter reason", "It was confirmed failed");
             if (reason != null) {
                console.log(ref);
                window.location.href = "<?php echo BASEURL; ?>payment/markFailed/"+ref+"/"+reason;
              } 
            }
            </script>          
