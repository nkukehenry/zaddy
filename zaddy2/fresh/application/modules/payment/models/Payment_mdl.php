...
function __construct()
    ...
    public function markAsSuccess($ref,$reason){
        ...
        $status=array('tranStatus'=>'SUCCESSFUL','responseCode'=>'90009A','finalStatus'=>'SUCCESSFUL','narration'=>$reason);
    ...
    public function markAsFailed($ref,$reason){
        ...
        $status=array('tranStatus'=>'FAILED','responseCode'=>'90009F','finalStatus'=>'FAILED','narration'=>$reason);
        $this->db->where('requestRef',$ref);
        $this->db->update($this->table,$status);
        return true;
    }
